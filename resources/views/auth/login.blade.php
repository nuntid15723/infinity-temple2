            ...
            <div class="col-md-6">
                ...
                <div class="col-md-4 offset-3 ">
                    <div class="card-header bg-white">
                        <h1 style="margin: 10px; font-family: 'Kanit', sans-serif; font-weight:600; "> {{ __('เข้าสู่ระบบ') }}</h1>
                    </div>
                </div>
                        ...
                        <div class="row mb-4" style="margin: auto;">
                            <div class="col-md-6 offset-md-2">
                                <input id="numberphone" type="numberphone"
                                    ...
                                    placeholder="เบอร์โทร" name="numberphone" name="numberphone"
                                    value="{{ old('numberphone') }}" required autocomplete="numberphone" autofocus>
                                @error('numberphone')
                        ...
                        <div class="row mb-3" style="margin: auto;">
                            <div class="col-md-6 offset-2 ">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember"  style="font-family: 'Prompt', sans-serif; font-weight:400;">
                                        {{ __('Remember Me') }}
                                    </label>
                                </div>
                            </div>
