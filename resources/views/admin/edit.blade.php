            ...
            <div class="col-sm-10">
                <div class="card" style="block-size: 1400px; font-family: 'Prompt', sans-serif; font-weight:400;" >
                    ...
                    <form style="margin: 20px">
                        ...
                        <div class="form-group row offset-1">
                            <label for="exampleInputType" class="col-sm-3 col-form-label" style="margin-bottom:8px; font-family: 'Kanit', sans-serif; font-weight:600;">คำนำหน้า</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group row offset-1">
                            <label for="exampleInputUsername" class="col-sm-3 col-form-label" style="margin-bottom:8px; font-family: 'Kanit', sans-serif; font-weight:600;">ชื่อ - นามสกุล </label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="exampleInputUsername"
                                    style="font-family: fontawesome; "  placeholder="&#xf007; ชื่อ - นามสกุล">
                            </div>
                        </div>
                        <div class="form-group row offset-1">
