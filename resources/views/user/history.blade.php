            ...
            <div class="row mb-2">
                <div class="col-sm-6 ">
                    <div style="font-family: 'Kanit', sans-serif; font-weight:600;">
                        <h1 class="m-0" style="color:#164176"><img src="{{ asset('images/graph.png') }}" alt=""
                                class="mr-3">สรุปผลการลา</h1>
                    </div>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <div class="row ">
        <div class="col-lg-12 ">
            <div class="card" style="margin: 25px">
                <div class="card-body ">
                    <div style="font-family: 'Kanit', sans-serif; font-weight:600;">
                        <h1 class="m-0" style="color:#164176">ประวัติการลา</h1>
                    </div>
                            ...
                            <table class="table table-xs mb-0" style="font-family: 'Prompt', sans-serif; font-weight:400;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-family: 'Kanit', sans-serif; font-weight:600; color:#FFD027">วันที่ลา</th>
                                        <th style="font-family: 'Kanit', sans-serif; font-weight:600; color:#164176">วันที่สิ้นสุด</th>
                                        <th style="font-family: 'Kanit', sans-serif; font-weight:600; color:#FFD027">ประเภทการลา</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="card"
                                                style="background-image: linear-gradient(#F8A8FF, #FD6585, #FC76A3 ); margin-bottom: 1px; margin-bottom: 1px; font-family: 'Kanit', sans-serif; font-weight:600;">
