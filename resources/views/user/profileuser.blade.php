            ...
            <div class="row mb-2">
                <div class="col-sm-6 ">
                    <div style="font-family: 'Kanit', sans-serif; font-weight:600;">
                        <h1 class="m-0" style=" color:#164176"><img src="{{ asset('images/profileuser.png') }}"
    ...
    <div class="container" style="font-family: 'Kanit', sans-serif; font-weight:400;">
        <div class="card">
            <div class="row">
              <div class="col-md-2" >
                  <br>
                <img img src={{ '/images/profile.png' }} class="img-fluid rounded-start" alt="..." style="margin-left: 24px;">
              </div>
              <div class="col-md-3">
                <div class="card-body">
                  <h5 class="card-title">สุดสวย สวยที่สุด</h5>
                  <p class="card-text" style="font-family: 'Kanit', sans-serif; font-weight:400;">123456789</p>
                  <button type="button" class="badeg badge-pill btn btn-outline-background-color text-white"  style="background-image: linear-gradient(230deg, #7EA3D1, #164176, #164176 ); margin-bottom: 1px;" data-dismiss="modal">แก้ไข</button>
                  </div>
                </div>
                <div class="col-md-3">
                    <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-8">
                  <div class="card" style="font-family: 'Prompt', sans-serif; font-weight:400;">
                    <div class="card-body">
                        <h5 class="card-title text-primary" style="font-family: 'Kanit', sans-serif; font-weight:600;">ประวัติการลา</h5>
                        <div class="table-responsive">
                            <table class="table table-hover">
                              <thead>
                                <tr>
                                  <th class="text-primary" style="font-family: 'Kanit', sans-serif; font-weight:600;">#</th>
                                  <th class="text-warning" style="font-family: 'Kanit', sans-serif; font-weight:600;">ชื่อ</th>
