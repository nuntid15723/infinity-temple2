            ...
            <div class="row" style="font-family: 'Prompt', sans-serif; font-weight:600;">
                ...
                <div class="col-sm-10">
                    <div class="card">
                        ...
                        <form style="margin: 30px" action="{{ route('insertform') }}" enctype="multipart/form-data "
                            method="post">
                            @csrf
                            ...
                            <div class="form-group row offset-1">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control" name="Typeofleave">
                                        ...
                                        <option class="btn btn-primary" data-toggle="collapse" name=""
                                            href="#collapseExample" role="button" aria-expanded="false" name=""
                                            aria-controls="collapseExample">ลาป่วย
                                        </option>
                                    </select>
                                ...
                                <div class="form-group row offset-1">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="custom-file">
                                            <input type="file" name="lafile" class="custom-file-input"
